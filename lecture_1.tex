...
\marker{Remark} This rough treatment is actually paradoxical; we'll resolve the paradox tomorrow.
...
\begin{frame}{Non-derivable propositions}

Assuming |P : U| and |Q : U|:
\begin{center}
\begin{tabular}{ll}
We can derive & but not \\ \hline \\[-2ex]
...
\todo[inline]{immediate recognisability (canonical vs non-canonical elements)}
